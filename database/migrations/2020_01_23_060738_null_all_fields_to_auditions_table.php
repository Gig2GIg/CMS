...
class NullAllFieldsToAuditionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('auditions', function (Blueprint $table) {
            DB::statement('ALTER TABLE `auditions` CHANGE `title` `title` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL');

            DB::statement('ALTER TABLE `auditions` CHANGE `description` `description` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL');

            DB::statement('ALTER TABLE `auditions` CHANGE `url` `url` VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL');
